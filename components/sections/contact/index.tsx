...
export default function Contact() {
  ...
  return (
    <motion.section
      id="contact"
      ref={ref}
      className="flex w-full scroll-mt-0 flex-col items-center py-20 pb-44 text-center dark:bg-darkBg dark:text-white"
      initial={{
        opacity: 0.8,
      }}
      whileInView={{
    ...
    >
      ...
      <div className="w-[min(100%,38rem)] px-4">
        <p className="mb-20 mt-6 text-gray-700 dark:text-white/80">
          ...
          <a className="underline" href="mailto:rozales@kaizendev.me">
            rozales@kaizendev.me
          </a>{" "}
